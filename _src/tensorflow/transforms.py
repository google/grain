...
Transformations = Sequence[Union[LocalTransform, GlobalTfDataTransform]]
    ...
    if isinstance(t, MapTransform):
      ...
      try:
        ...
        logging.warning(
            ...
            "`grain.MapTransform.`", t)
      except AttributeError:
        if strict:
          raise ValueError(f"Using unsafe transformation {t}. Please switch "  # pylint: disable=raise-missing-from
        ...
        logging.warning(
            "Applying potential unsafe preprocessor %s. Are you "
            "using plain SeqIO preprocessors?", t)
        ds = t(ds)
  return ds
