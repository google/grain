...
* New features:
  ...
  * Adds Windows build.
  * Introduces API for autotuning:
    * Finds number of processes for `mp_prefetch`, given the user provided RAM restrictions and specific `IterDataset`.
    * Finds number of threads for `PrefetchIterDataset`, given the user provided RAM restrictions, specific `IterDataset` and buffer size.
