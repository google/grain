...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | PrefetchDatasetIterator        | [2]    | N/A               | 400.00us              | 400ns               | 40.00us             | 40.00us             | 10                    | 48.83 kB     |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
"""
  ...
  def test_memory_usage(self):
    ...
    ds = dataset.MapDataset.source([np_array, test_string, shm_meta])
    ...
    it = ds.__iter__()
    _ = list(it)
    time.sleep(1)  # Allow reporting thread to run.
