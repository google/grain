...
@dataset_stats.trace_input_pipeline(name="SynchroThreadPrefetch")
def _getitem(
...
class GetElementProducerFn(grain_pool.GetElementProducerFn, Generic[T]):
  ...
  @dataset_stats.trace_input_pipeline(name="WorkerPrefetch")
  def __call__(
      self,
      *,
      worker_index: int,
...
@dataset_stats.trace_input_pipeline(name="ThreadPrefetch")
