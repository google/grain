...
class StatsUtilsTest(absltest.TestCase):
  ...
  def test_get_allocated_bytes(self):
    ...
    self.assertEqual(stats_utils.get_allocated_bytes(np_array), 40)
    self.assertEqual(stats_utils.get_allocated_bytes(test_string), 11)
    self.assertEqual(stats_utils.get_allocated_bytes(shm_meta), 40)
