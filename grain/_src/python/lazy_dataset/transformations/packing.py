...
class FirstFitPackLazyIterDataset(lazy_dataset.LazyIterDataset):
  ...
  (usually the botton bins) have a lot of padding. To avoid pattern we shuffle
  the bins. For large number of bins this create epoch leakage.
  """
  ...
  def __init__(
    ...
    """Creates a dataset that packs sequences from the the parent dataset.
