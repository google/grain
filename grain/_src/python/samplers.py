...
from grain._src.python.lazy_dataset.transformations import shuffle as shuffle_dataset
import numpy as np
...
class IndexSampler:
  ...
  def __init__(
    ...
    if shuffle:
      self._record_keys = shuffle_dataset.ShuffleMapDataset(
          self._record_keys, seed=seed
      )
